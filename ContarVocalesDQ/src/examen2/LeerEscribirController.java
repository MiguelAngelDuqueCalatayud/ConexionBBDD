...
public class LeerEscribirController implements Initializable {
    ...
    @FXML
    private void escribirArchivo(ActionEvent event) throws IOException {
        textArea.setText(textArea.getText());
        File newTxt = new File(pathDestino.getText());
        BufferedWriter bufferWriter = new BufferedWriter(new FileWriter(newTxt));
